...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            // we're not actually doing anything with DB at this point
            // just saving in memory
            _context.Add(entity);
        }
        ...
        {
            // get first or default where user id matches liker id and recipient matches likee
        ...
        private async Task<IEnumerable<int>> GetUserLikes(int id, bool likers)
        {
            ...
            if (likers)
            {
                // returns lists of likers of current user
        ...
        public async Task<PagedList<Message>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            // only return messages that weren't deleted
